...
public class AuthenticationController {
	...
	@Autowired
	public AuthenticationController(UserRepository userRepository, UserMapper userMapper, SecurityService securityService) {
	...
	public void authenticate(@RequestBody @Valid  LoginDto loginDto, HttpServletResponse response) {
		User user = userRepository.findByLoginAndPassword(loginDto.getLogin(), loginDto.getPassword()).orElseThrow(() ->
